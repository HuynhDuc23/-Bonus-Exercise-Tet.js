...
//console.log(mySort([-10,22,333,42],[-11,5,22 ,41,42]))

function myFunctiontt(a) {
  let stringA = "";
...
console.log(myFunctiontt("abcdefgh"));
...
console.log(test('check','cake'));
    

function removeNCharator(str) {
    let len = str.length ;
    let result = 0 ;
...
console.log(removeNCharator('fgedcba'))
